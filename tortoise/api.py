...
DEFAULT_MODELS_DIR = 'tortoise_models'
...
class TextToSpeech:
    ...
    def tts_with_preset(self, text, preset='fast', **kwargs):
        ...
        presets = {
            'super_fast': {'num_autoregressive_samples': 8, 'diffusion_iterations': 24, 'cond_free': False},
            'ultra_fast': {'num_autoregressive_samples': 16, 'diffusion_iterations': 30, 'cond_free': False},
            'fast': {'num_autoregressive_samples': 96, 'diffusion_iterations': 80},
            'standard': {'num_autoregressive_samples': 256, 'diffusion_iterations': 200},
            'high_quality': {'num_autoregressive_samples': 256, 'diffusion_iterations': 400},
            'custom': {'num_autoregressive_samples': 48, 'diffusion_iterations': 40, 'cond_free': False},
        }
    ...
    def tts(self, text, voice_samples=None, conditioning_latents=None, k=1, verbose=True, use_deterministic_seed=None,
            ...
            #num_autoregressive_samples=8, temperature=.2, length_penalty=0.55, repetition_penalty=1.0, top_p=.10, max_mel_tokens=500,
            # CVVP parameters follow
            cvvp_amount=.0,
            # diffusion generation parameters follow
            diffusion_iterations=100, cond_free=True, cond_free_k=2, diffusion_temperature=1.0, breathing_room=8,
            **hf_generate_kwargs):
        """
